...
class MAE3D(nn.Module):
    ...
    def __init__(self,
        ...
        self.decoder = decoder(patch_size=patch_size, num_classes=out_chans)
...
def build_vit_base_mae_3d(args):
    from models.fix.networks.vit import vit_base_patch16_96, decoder_base_patch16_96
    return MAE3D(args=args, encoder=vit_base_patch16_96, decoder=decoder_base_patch16_96)
    
def build_vit_large_mae_3d(args):
    from models.fix.networks.vit import vit_large_patch16_96, decoder_large_patch16_96
    return MAE3D(args=args, encoder=vit_large_patch16_96, decoder=decoder_large_patch16_96)  

def build_vit_large_mae_p12_3d(args):
    from models.fix.networks.vit import vit_large_patch12_96, decoder_large_patch12_96
    model = MAE3D(args=args, encoder=vit_large_patch12_96, decoder=decoder_large_patch12_96)
    print(model)
    return model
    
def build_vit_base_mae_p8_3d(args):
    from models.fix.networks.vit import vit_base_patch8_96, decoder_base_patch8_96
    model = MAE3D(args=args, encoder=vit_base_patch8_96, decoder=decoder_base_patch8_96)
    print(model)
    return model